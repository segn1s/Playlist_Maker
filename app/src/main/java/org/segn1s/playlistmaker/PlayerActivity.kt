...
class PlayerActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tvDurationLabel = findViewById<TextView>(R.id.track_duration)
        val tvAlbumLabel = findViewById<TextView>(R.id.album_info)
        val tvYearLabel = findViewById<TextView>(R.id.release_year)
        val tvGenreLabel = findViewById<TextView>(R.id.genre_info)
        val tvCountryLabel = findViewById<TextView>(R.id.country_info)
